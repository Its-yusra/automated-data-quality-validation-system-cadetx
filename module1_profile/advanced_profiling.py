...
def create_advanced_report(df):
    ...
    report = {
        "dataset": {
            "name": "UCI Diabetes 130-US Hospitals",
            "rows": int(df.shape[0]),
        ...
        "suspicious_column_rule":
            "Columns containing ID, number, name, email, phone, or address"
    }
...
def main():
    ...
    print("Creating advanced profiling report...")
    ...
    print("results/advanced_profiling_report.json")
